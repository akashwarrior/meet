    ...
    return <>
        ...
        <header className="w-full h-16 flex fixed bg-[#000000cc] top-0 justify-between items-center px-4 shadow-[inset_0_-1px_0_0_#333] backdrop-blur-[6px] backdrop-saturate-[180%] z-10">
            ...
            <button
                ...
                className="bg-[#1a1a1a] outline-none cursor-pointer border-none flex items-center justify-between min-w-[237px] rounded-md px-3 text-[#8f8f8f] h-8 transition-all duration-150 hover:bg-[#262626] hover:text-white"
            >
                Search user..
