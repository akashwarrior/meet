    ...
    return (
        <section className="flex items-center justify-center m-auto mt-[5%] flex-wrap h-fit pb-7 gap-8">
            {users.map((user) => (
                <div
                    key={user.uid}
                    className="relative w-fit px-16 py-12 bg-black rounded-xl flex items-center justify-center flex-col flex-wrap select-none drop-shadow-xs shadow-[0_0_0_1px_hsla(0,0%,100%/14%),0_1px_1px_rgba(0,0,0/2%),0_8px_16px_-4px_rgba(0,0,0/4%),0_24px_32px_-8px_rgba(0,0,0/6%)]"
                >
                    ...
                    <Button
                        className={"bg-[#0070f3] text-white border-none w-full rounded-md h-10 cursor-pointer font-semibold z-30 outline-hidden mt-5 flex items-center justify-center transition-all duration-200 hover:bg-[#0077ffb1] active:bg-[#4d4dff]"}
                        data={{ uid: user.uid }}
                    >
                        Connect
                    </Button>
