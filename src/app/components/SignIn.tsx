...
const Signin = () => {
    ...
    const [requiredError, setRequiredError] = useState({ emailReq: false, passReq: false });
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className='flex flex-1 flex-col gap-3 items-center'>
                        ...
                        <p className="text-sm tracking-tighter text-white">
                            ...
                            <Link href={"/signup"}>
                                <span className="text-blue-500 hover:underline cursor-pointer font-bold">Sign Up</span>
                            </Link>
                        </p>
                    </div>
                </div>
