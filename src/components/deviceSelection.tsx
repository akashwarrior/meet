                ...
                <DropdownMenu modal={false}>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            ...
                            >
                                {audioDevices?.[0]?.deviceId ? audioDevices.find(device => device.deviceId === audioActiveDeviceId)?.label || audioDevices[0].label : "Permission needed"}
                            </motion.span>
                            <ChevronDown />
                        </Button>
                    </DropdownMenuTrigger>
                    ...
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            ...
                            <motion.span
                                ...
                                transition={{ duration: 0.3 }}
                            >
                                {speakerDevices?.[0]?.deviceId ? speakerDevices.find(device => device.deviceId === speakerActiveDeviceId)?.label || speakerDevices[0].label : "Permission needed"}
                            </motion.span>
                            <ChevronDown />
                        </Button>
                    </DropdownMenuTrigger>
                    ...
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            ...
                            <motion.span
                                ...
                                transition={{ duration: 0.3 }}
                            >
                                {videoDevices?.[0]?.deviceId ? videoDevices.find(device => device.deviceId === videoActiveDeviceId)?.label || videoDevices[0].label : "Permission needed"}
                            </motion.span>
                            <ChevronDown />
                        </Button>
                    </DropdownMenuTrigger>
